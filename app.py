...
app.config["MONGO_URI"] = "mongodb+srv://cherifaswak:cherif**2019@renderproject1cluster.tc990wu.mongodb.net/dbstore?retryWrites=true&w=majority"
...
if __name__ == '__main__':
    ...
    app.run(host="44.227.217.144", port=port)
